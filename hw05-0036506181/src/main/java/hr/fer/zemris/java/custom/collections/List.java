...
/**
 * Interface is a specific case of interface Collection where elements are
 * stored in a indexed structure and therefore include the functionality of
 * getting, removing and inserting elements at specified index
 * 
 * @author Frano Rajič
 *
