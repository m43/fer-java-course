...
/**
 * Filter that makes sure an connection will be reserved from connection poll
 * for every thread to work with. The connection is only reserved for servlets
 * which must be linked to a URL pattern starting with /servleti/...
 * 
 * @author Frano Rajič
 */
