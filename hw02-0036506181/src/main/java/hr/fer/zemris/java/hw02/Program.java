...
/**
 * Program for testing created classes and given examples.
 */

public class Program {

	/**
	 * Program for testing created collections ArrayIndexedCollection and
	 * LinkedListIndexedCollection. Example taken from homework assignment paper.
	 * 
