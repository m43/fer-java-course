 ...
 * Gives the functionality of creating {@link SmartScriptToken} tokens and
 * getting the last one generated
 * 
 * @author Frano
 * 
 */
public class SmartScriptLexer {
	...
	/**
	 * Create a new {@link SmartScriptLexer} with given text to tokenize
	 * 
