...
public class Prob1Test {
	...
	public void testWordWithManyEscapesAndNumbers() {
		// Lets check for several words...
		Lexer lexer = new Lexer("  123ab\\123cd ab\\2\\1cd\\4\\\\ \r\n\t   ");

		// We expect following stream of tokens
		Token correctData[] = { new Token(TokenType.NUMBER, Long.valueOf(123)), new Token(TokenType.WORD, "ab1"),
				new Token(TokenType.NUMBER, Long.valueOf(23)), new Token(TokenType.WORD, "cd"),
